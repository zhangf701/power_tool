...
DISPLAY_ZH_TO_EN: dict[str, str] = {
    ...
    "导出": "Export",
    "导入训练CSV": "Import training CSV",
    "导入天气CSV": "Import weather CSV",
    "导入未来天气CSV": "Import Future Weather CSV",
    "选择预测训练CSV": "Select forecast training CSV",
    "选择未来天气预报CSV": "Select future-weather forecast CSV",
    "天气CSV导入失败": "Weather CSV import failed",
    "取消": "Cancel",
    "浏览...": "Browse...",
...
PHRASE_ZH_TO_EN: dict[str, str] = {
    ...
    "线路参数校核与标幺值转换（π 型等值）": "Line parameter validation and per-unit conversion (π equivalent)",
...
DISPLAY_ZH_TO_EN.update({
    ...
    "结论：正序参数可直接回填“线路”页，零序参数可同步回填“短路电流计算”页。": "Conclusion: the positive-sequence parameters can be written back directly to the Line page, and the zero-sequence parameters can be written back to the Short-Circuit Current Calculation page.",
